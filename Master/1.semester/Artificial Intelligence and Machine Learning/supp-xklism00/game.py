...
# Date: 9.10.2021
# Co-authors: Jan Lorenc, Michal Kliš, Michal Sova, Jana Gregorová
# Faculty: Faculty of information technology VUT
# Description: Original server/game.py script with added data collection.
#              To collect data, just replace the files.
...
class Game:
    ...
    def run(self):
        ...
        """
        data_collector = DataCollector()  # ADDITION - instantiate data collector
        try:
            ...
            while True:
                ...
                if self.check_win_condition():
                    ...
                    data_collector.save_game_result(self.board, self.players)  # ADDITION - saves the whole game
                    break

                data_collector.save_state(self.board, self.players)  # ADDITION - saves the game state
